...
def file_get_contents(example):
    current_example = os.getcwd() + '/examples/{0}.java'.format(example)
...
def create_list():
    ...
    for service in services:
        ...
        body += '''
                    ...
                    <section>
                    <h3>Source</h3>
                    <pre class="prettyprint"><code class="language-java">{1}</code></pre>
                    </section>
                    <section>
                    <h3>Output</h3>
                    {2}
